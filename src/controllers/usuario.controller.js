...
const obtenerTodo = async (req, res) => {
    ...
    try {
        ...
        return httpError(res, "Ocurrio error en Get Usuarios");
    }
}
...
const obtenerUnoSolo = async (req, res) => {
    ...
    try {
        ...
        return httpError(res, "Ocurrio error en Get Usuario");
    }
}
...
const agregarUsuario = async (req, res) => {
    try {
        ...
        return httpError(res, "Ocurrió error en POST Usuario");
    }
}
...
const editarUsuario = async (req, res) => {
    try {
        ...
        return httpError(res, "Ocurrio error en PUT Usuario");
    }
}
...
const eliminarUsuario = async (req, res) => {
    try {
        ...
        return httpError(res, "Ocurrio error en DELETE Usuario");
    }
